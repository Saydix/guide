...
Необходимо выбрать «Открыто» в пункте [выбор когда](#выбор-когда) и в [действии для INCY](#действие-incy) - "Отключить"

После добавить вторую автоматизацию [выбор когда](#выбор-когда) «Закрыто» и в [действии для INCY](#действие-incy) - "Включить"
